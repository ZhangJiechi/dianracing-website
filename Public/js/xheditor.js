...
var xheditor=function(textarea,options)
{
	...
	var headHTML='',bodyClass='',skinPath=editorRoot+'../xheditor/skin/'+settings.skin+'/',arrEmots=itemEmots,urlType=settings.urlType,urlBase=settings.urlBase,emotPath=settings.emotPath,emotPath=emotPath?emotPath:editorRoot+'../xheditor/emot/',selEmotGroup='';
